...
±±³Fun‡…o    ³ ped_ven    ³ Autor ³ Sidinei             ³ Data ³ 29/07/17 ³±±
...
"N",;                         		// 4-Tipo da NF
IIF(SC5->C5_TIPO='D' .OR. SC5->C5_TIPO='B',SA2->A2_TIPO,SA1->A1_TIPO),;                      // 5-Tipo do Cliente/Fornecedor
...
oPrinter:Say( nTopoBox+nTot+nPosBox+(nEL8*4),nMeio+083,"Valor Frete: ",oFont82)
oPrinter:Say( nTopoBox+nTot+nPosBox+(nEL8*4),nMeio+160,Transform(nValFrete,"@E 9,999,999.99"),oFont82)
oPrinter:Say( nTopoBox+nTot+nPosBox+(nEL8*5)+3,nMeio+083,"Valor Total: ",oFont8)
oPrinter:Say( nTopoBox+nTot+nPosBox+(nEL8*5)+3,nMeio+160,Transform(nValFrete+nTOTIPI+nTotal,"@E 9,999,999.99"),oFont8)
