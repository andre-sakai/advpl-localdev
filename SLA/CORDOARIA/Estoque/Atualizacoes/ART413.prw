...
±±ºPrograma  ³ ART413   ºAutor  ³Eduardo Marquetti  º Data ³  01/03/12   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Inclusao e Apontamento da producao via leitor Cod Barras   º±±
...
DEFINE MSDIALOG oDlgPrinc TITLE OemToAnsi("Apontamento da Produ‡„o - Codigo de Barras") FROM 01,01 TO 510,900 PIXEL
...
cNumDoc:=GetSx8Num("SD3", "D3_DOC") // Pega Numeração Automatica
cTpApont := "T"

/* Teste - Outro Método para usar Numeração SD3 sem o GetSX8Num
...
cFrom		:= "microsiga@arteplas.com.br"
cEmail		:= "rogerio@arteplas.com.br;microsiga@arteplas.com.br"
...
Private limite       	:= 80
Private tamanho      	:= "P"
Private nomeprog     	:= "ART413" // Nome do programa para impressao no cabecalho
Private nTipo        	:= 18
...
Private CONTFL     		:= 01
Private m_pag      		:= 01
Private wnrel      		:= "ART413" // Nome do arquivo usado para impressao em disco
Private cString   		:= "SD3"
...
if !EMPTY(TRB->PRODUTO)
	If MsgBox("Confirma exclusao deste registro ?","Escolha","YESNO")
		...
		nQuant2UM := nQuant2UM - TRB->Quantid2UM
		RecLock("TRB",.f.)
		DbDelete()
		MsunLock("TRB")
		nSeq:=nSeq - Itens
